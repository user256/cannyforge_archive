...
- [x] `readme.txt` inventories OAuth token exchange, refresh, and revocation;
...
- [x] For each call, the disclosure states the user action or automated trigger,
...
- [x] The automatic Search Console property-list call immediately after a
      relevant successful connection is explicitly documented.
- [x] Links resolve to Google APIs Terms, Google API Services User Data Policy,
      and Google Privacy Policy; GA4 terms are linked where applicable.
- [x] The FAQ is consistent with the External services section and does not
      claim an exhaustive disclosure while omitting traffic.
- [x] Readme validation and the WordPress Plugin Check pass; focused tests or
...
- 2026-07-23 — Expanded the public disclosure to enumerate OAuth, property-list,
  report, revocation, trigger, response, retention, and policy details.
